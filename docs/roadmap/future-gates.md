...
| 10E | Real trainer-backend contract and execution preflight (first Hugging Face/PEFT integration, behind the proven plan/execution/checkpoint contracts; real checkpoint formats introduced as NEW explicit format specs) | 4 | planned (deferred behind 10A–10D) |
