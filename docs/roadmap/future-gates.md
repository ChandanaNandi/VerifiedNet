...
| 10D | Immutable checkpoint contracts (fake checkpoints only) | 4 | planned — checkpoint identity/lineage/manifest contracts proven against the Gate 10C lifecycle before any real weights exist |
| 10E | Real trainer backend (first Hugging Face/PEFT integration, behind the proven plan/execution/checkpoint contracts) | 4 | planned (deferred behind 10A–10D) |
