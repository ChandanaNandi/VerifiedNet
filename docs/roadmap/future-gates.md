...
| 10F | First bounded real training execution (tiny approved model + corpus slice, consuming a verified Gate 10E authorization; torch-backed probe, `verifiednet[training-hf]` extras, first real checkpoint as a NEW explicit format spec) | 4 | planned (deferred behind 10A–10E) |
