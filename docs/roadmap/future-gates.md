...
| 10G | Checkpoint-backed prediction behind the Gate 8 feature-only interface, then evaluation and Gate 9 benchmark comparison | 3, 4 | planned (deferred behind 10F) |
