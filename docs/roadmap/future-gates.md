...
| 6 | Verified dataset engine and leakage-safe splits (incident corpus, provenance) | 2 | planned, next — engine plan approved (Gate 6.0): see `../architecture/gate6/gate6-roadmap.md` |
